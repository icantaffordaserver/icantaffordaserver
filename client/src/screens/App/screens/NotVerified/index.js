...
import ResendVerificationEmailButtonContainer from "./containers/ResendVerificationEmailButtonContainer";
  ...
  render() {
    ...
    return (
      <MessageContainer>
        ...
        <h1>
          You must verify your email address before you can begin using Shift
        </h1>
